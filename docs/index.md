...
<div class="hero-kicker">Robotics, Controls, Embedded Software, Experimental Tools</div>
...
<div class="start-grid">
  <a class="start-card" href="projects/index.md">
    ...
    <p>Start with the larger technical case studies: racecar localization, manufacturing ML, crack detection, and streaming infrastructure.</p>
  </a>
  <a class="start-card" href="writing/index.md">
    <h3>Writing and Notes</h3>
    <p>Shorter technical writing on experiments, engineering tradeoffs, and the small tools that keep turning out to be useful.</p>
  </a>
  <a class="start-card" href="experience.md">
    <h3>Experience and Background</h3>
    <p>Background, roles, and the through-line connecting robotics, controls, embedded systems, and software.</p>
  </a>
  <a class="start-card" href="toys/index.md">
    <h3>Toys and Experiments</h3>
    <p>Interactive browser-side demos, lightweight sketches, and small prototypes that do not fit the main project pages.</p>
  </a>
  <a class="start-card" href="contact.md">
    <h3>Where Else I Post</h3>
    <p>External links, archive destinations, and the places where demos, posts, and future public repos will live.</p>
  </a>
</div>
...
<div class="award-grid">
  <div class="award-card">
    <a class="award-image-link" href="assets/fll-2011-award.jpg" target="_blank">
      <img src="assets/fll-2011-award.jpg" alt="Open European Championship FLL 2011 award coverage" class="award-image" />
    </a>
    <div class="award-copy">
      <div class="hero-kicker">Featured Recognition</div>
      <h3>Open European Championship FLL, Delft</h3>
      <p class="award-meta">2011 | Best Project Award</p>
      <p>
      ...
      <p><a href="assets/fll-2011-award.jpg" target="_blank">Open award image</a></p>
    </div>
  </div>
</div>
...
<div class="start-grid">
  <a class="start-card" href="toys/index.md#scrollable-grid-demo">
    ...
    <p>A browser-based interaction toy for placing and navigating pieces on a large grid. This section is ready for more sketches as you surface them.</p>
  </a>
</div>
